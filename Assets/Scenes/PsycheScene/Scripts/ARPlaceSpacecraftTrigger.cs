...
{
    public class ARPlaceSpacecraftTrigger : MonoBehaviour
    {
        ...
        [SerializeField] PlaceSpacecraft m_SpacecraftPlacer;
        public PlaceSpacecraft spacecraftPlacer { get => m_SpacecraftPlacer; set => m_SpacecraftPlacer = value; }
        ...
        void OnEnable() => m_SpawnObjectInput.EnableDirectActionIfModeUsed();
        void OnDisable() => m_SpawnObjectInput.DisableDirectActionIfModeUsed();

        void Start()
        {
            if (m_SpacecraftPlacer == null)
#if UNITY_2023_1_OR_NEWER
                m_SpacecraftPlacer = FindAnyObjectByType<PlaceSpacecraft>();
#else
                m_SpacecraftPlacer = FindObjectOfType<PlaceSpacecraft>();
#endif
        ...
        void Update()
        {
            if (m_AttemptSpawn)
            {
                ...
                if (!isPointerOverUI && m_ARInteractor.TryGetCurrentARRaycastHit(out var arRaycastHit))
                {
                    ...
                    m_SpacecraftPlacer.TryPlaceSpacecraft(arRaycastHit.pose.position, arPlane.normal);
                }
