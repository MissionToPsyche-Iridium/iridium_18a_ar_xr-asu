...
{
    public class ARSpawnSpacecraftTrigger : MonoBehaviour
    {
        ...
        [SerializeField] SpawnSpacecraft m_SpawnSpacecraft;
        public SpawnSpacecraft spacecraftSpawner { get => m_SpawnSpacecraft; set => m_SpawnSpacecraft = value; }
        ...
        void Start()
        {
            if (m_SpawnSpacecraft == null)
#if UNITY_2023_1_OR_NEWER
                m_SpawnSpacecraft = FindAnyObjectByType<SpawnSpacecraft>();
#else
                m_SpawnSpacecraft = FindObjectOfType<SpawnSpacecraft>();
#endif
        ...
        void Update()
        {
            if (m_AttemptSpawn)
            {
                ...
                if (!isPointerOverUI && m_ARInteractor.TryGetCurrentARRaycastHit(out var arRaycastHit))
                {
                    ...
                    m_SpawnSpacecraft.TrySpawnObject(arRaycastHit.pose.position, arPlane.normal);
                }
